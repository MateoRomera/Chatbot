#!/usr/bin/env python3
"""
Script de inicio rápido para SDF Assistant
"""
...
==========================================
¡Bienvenido! Este script te ayudará a configurar SDF Assistant rápidamente.
""")
...
def create_env_file():
    ...
    if not env_file.exists():
        with open(env_file, "w", encoding="utf-8") as f:
            f.write("# Configuración básica de SDF Assistant\n")
            f.write("OLLAMA_MODEL=gpt-oss:20b\n")
            f.write("STREAMLIT_PORT=8502\n")
...
def show_next_steps():
    ...
    print("2. 🚀 Ejecuta: python run_sdf.py")
    print("3. 🌐 Abre tu navegador en: http://localhost:8502")
    ...
    print("\n🔧 Si tienes problemas:")
    print("   - Ejecuta: python check_system_sdf.py")
    print("   - Ejecuta: python setup_sdf.py")
    
    print("\n💡 Comandos útiles:")
    print("   python run_sdf.py           # Iniciar SDF Assistant")
    print("   python check_system_sdf.py  # Verificar sistema")
    print("   iniciar_sdf.bat            # Script Windows")
