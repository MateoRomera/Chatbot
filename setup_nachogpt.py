#!/usr/bin/env python3
"""
Script de instalación y configuración para NachoGPT
"""
...
def create_env_file():
    ...
    if not env_file.exists():
        ...
        with open(env_file, "w", encoding="utf-8") as f:
            f.write("# Configuración de NachoGPT\n")
...
def main():
    ...
    print("\n" + "=" * 40)
    print("🎉 ¡NachoGPT instalado correctamente!")
    print("\n📋 Próximos pasos:")
    ...
    print("3. Ejecuta: python run_nachogpt.py")
    print("4. O ejecuta: iniciar_nachogpt.bat (Windows)")
