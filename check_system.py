#!/usr/bin/env python3
"""
Script de verificación del sistema para NachoGPT
"""
...
def main():
    ...
    print("🔍 Verificación del Sistema - NachoGPT")
    print("=" * 50)
    ...
    if all_passed:
        ...
        print("🚀 Puedes ejecutar NachoGPT sin problemas")
        print("\n💡 Para iniciar:")
        print("   python run_nachogpt.py")
        print("   o")
        print("   iniciar_nachogpt.bat")
    else:
        print("⚠️ Se encontraron problemas:")
        print("💡 Revisa los errores arriba y soluciona los problemas")
        print("💡 Ejecuta: python setup_nachogpt.py para instalación automática")
