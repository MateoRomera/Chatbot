#!/usr/bin/env python3
"""
SDF Assistant - System Check Script
...
def check_folders():
    ...
    try:
        from config import Config
        folders = [Config.CONTEXT_FOLDER, "vector_db", "logs", "backups", "exports", "temp"]
    except ImportError:
        folders = ["contexto", "vector_db", "logs", "backups", "exports", "temp"]
