            ...
            for sheet_name in excel_file.sheet_names:
                try:
                    ...
                    if not df.empty:
                        ...
                        content.append("Columnas: " + ", ".join(str(col) for col in df.columns.tolist()))
                        content.append("Primeras 10 filas:")
                    ...
                    content.append(f"Error procesando hoja {sheet_name}: {str(e)}")
                    continue
            ...
            for future in concurrent.futures.as_completed(future_to_file):
                ...
                try:
                    ...
                    if result.get("success", False):
                        ...
                        logger.warning(f"❌ Error en {file.name}: {result.get('error', 'Error desconocido')}")
                except Exception as e:
